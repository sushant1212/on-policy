...
exp="Terran_5v5_limitedComms"
comms_experiment="LimitedComms"
seed_max=5
...
do
    ...
    --num_env_steps 3000000 --ppo_epoch 15 --use_value_active_masks --use_comet  --share_policy --comms  --save_interval 1000000  \
